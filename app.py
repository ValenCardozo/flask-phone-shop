...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:@localhost/flask_phone_shop_new'
...
def marcas():
    ...
    return render_template("marcas.html", marcas=marcas, formulario=formulario)
